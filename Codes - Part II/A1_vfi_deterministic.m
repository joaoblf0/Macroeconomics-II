...
while iter <= max_iter && Vdiff>tol_iter
    ...
    for ia = 1:na
        ...
        % 1.0e-10 above: just a very low consumption which delivers large and
        % negative utility which is never chosen.
...
%     legend('Lowest income state','Highest income state');
    ...
    print -depsc2 'f_vfi_deterministic.eps'  
